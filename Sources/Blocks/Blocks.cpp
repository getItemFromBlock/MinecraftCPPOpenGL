...
void BlockRegister::RegisterBlocks(Resources::TextureAtlas* atlas)
{
	...
	(new LightBlock("glowstone", Core::Maths::Vec3D(1.0f, 1.0f, 0.7f)))->SetHardness(1.0f),
	(new LightBlock("sea_lantern", Core::Maths::Vec3D(0.7f, 0.7f, 1.0f)))->SetHardness(1.0f),
	(new TorchBlock("torch", Core::Maths::Vec3D(0.9f, 0.6f, 0.6f)))->SetHardness(0.5f),
	(new TorchBlock("redstone_torch", Core::Maths::Vec3D(0.5f, 0.1f, 0.1f)))->SetHardness(0.5f),
