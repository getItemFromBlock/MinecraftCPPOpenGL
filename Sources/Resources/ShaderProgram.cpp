...
void ShaderProgram::Reload(bool init)
{
	...
	locations[4] = glGetUniformLocation(programID, "Dmvp");
	...
	locations[13] = glGetUniformLocation(programID, "DLight");
	locations[14] = glGetUniformLocation(programID, "PLights");
	locations[15] = glGetUniformLocation(programID, "PLightsCount");
	locations[16] = glGetUniformLocation(programID, "DShadowMap");
	locations[17] = glGetUniformLocation(programID, "cameraPos");
	locations[18] = glGetUniformLocation(programID, "GlobalTime");
	locations[19] = glGetUniformLocation(programID, "RNGState");
	locations[20] = glGetUniformLocation(programID, "DeltaPos");
	locations[21] = glGetUniformLocation(programID, "DeltaUV");
	locations[22] = glGetUniformLocation(programID, "BonesMVP");
	locations[23] = glGetUniformLocation(programID, "BonesM");
}
