...
namespace LowRenderer::Lightning
{
	...
	public:
		...
		void UpdateShaders(Resources::ShaderProgram** shaderProgramCurrent, Resources::ShaderManager* manager, const Core::Maths::Vec3& cameraPos, std::vector<Core::Maths::Mat4>* lvp, float GlobalTime);
	...
	private:
		...
		void WriteLights(Resources::ShaderProgram** shaderProgramCurrent, Resources::ShaderProgram* shader, const Core::Maths::Vec3& cameraPos, std::vector<Core::Maths::Mat4>* lvp, bool first, float GlobalTime);
