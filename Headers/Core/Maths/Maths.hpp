...
namespace Core::Maths
{
    ...
    public:
        ...
        inline Int3D operator+(const Int3D& a) const;
        ...
        // Return the result of the aritmetic multiplication of 'a' and 'b'
        inline Int3D operator*(const float& a) const;

        // Return the result of the aritmetic division of 'a' and 'b', will return 'a' * VEC2D_HIGH_VALUE if 'b' is equal 0;
        inline Int3D operator/(const float& b) const;

        inline bool operator==(const Int3D& b) const;
    ...
    public:
        ...
        inline Vec3D(const Int3D& in) : x((float)in.x), y((float)in.y), z((float)in.z) {}
